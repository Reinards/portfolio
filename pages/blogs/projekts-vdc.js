...
export default function Blog() {
  return (
    ...
    title="Projekts Veģetatīvās Distonijas Centrs">
        ...
        <P>
          Veģetatīvās Distonijas Centrs ir viens no labākajiem piemēriem citiem uzņēmumiem, ja runājam par mājaslapas izveidi. VDC savu mājaslapu ir pilnveidojuši vairāk kā 3 reizes pēdējo 4 gadu laikā. Kādēļ? Tādēļ ka mājaslapa visu laiku tiek pielāgota, lai labāk rezonētu ar klientiem. Tiek veiktas aptaujas un ievāktas atsauksmes par to, cik viegli vai sarežģīti klientam ir izmantot mājaslapu.
          
          <br/><br/>
          
          Esmu piedalījies katrā no šīm reizēm un varu teikt, ka pašreizējā versija tik tiešām atspoguļo VDC vislabāk. Gan krāsu izvēle, gan viegli pārskatāmais dizains rada mierīgu atmosfēru, kas šī uzņēmuma klientiem ir tik ļoti nepieciešams.
        </P>
        
        <H2>Fokuss uz UX</H2>
        <P>
            VDC klienti ir cilvēki, kuriem ikdienā ir pietiekami daudz stresa un savu problēmu, par kurām domāt. Šādi cilvēki novērtēs dizainu, kas tiem nerada vēl vairāk pūļu. Tie novērtēs katru sīkumiņu, kas viņu darbu šajā mājaslapā atvieglos kaut par mazumiņu.
            <br/><br/>
        ...
        <P>
            ...
            Nav jāveic milzīgas izmaiņas pašā logo, pietiek izveidot 2 līdz 4 dažādas logo versijas un pārliecināties, ka katras versijas logo ir viegli saskatāms un tajā nav nekā lieka.
